...
const Canvas = ({ spreadId, cardList, showCardBack }: Props) => {
  const Card = ({ className, num }: { className: string; num: number }) => {
      ...
      case 'SINGLE': {
        return (
          <div className="flex h-full w-full items-center justify-center">
            <Card className="sm:!h-[210px]" num={1} />
          </div>
        );
      }
      case 'LINEAR': {
        return (
          <div className="absolute top-[140px] flex w-full items-center justify-center gap-10 sm:top-[180px] sm:gap-24">
            <Card className="sm:!h-40" num={1} />
            <Card className="sm:!h-40" num={2} />
            <Card className="sm:!h-40" num={3} />
          </div>
        );
      }
      case 'FOUR_ELEMENT': {
        ...
        return (
          <div className="flex flex-col gap-8 py-10 sm:py-20">
            <div className="flex justify-center">
              <Card className="!h-21 sm:!h-[98px]" num={1} />
            </div>
            <div className="flex w-full justify-center gap-[66px] sm:gap-33">
              <Card className="!h-21 sm:!h-[98px]" num={3} />
              <Card className="!h-21 sm:!h-[98px]" num={5} />
              <Card className="!h-21 sm:!h-[98px]" num={4} />
            </div>
            <div className="flex justify-center">
              <Card className="!h-21 sm:!h-[98px]" num={2} />
            </div>
          </div>
        );
      }
      case 'HEXAGRAM': {
        return (
          <div className="flex flex-col gap-2 py-6 sm:gap-4 sm:py-12">
            ...
            <div className="flex w-full justify-center gap-30 sm:gap-60">
              <Card className="!h-21 sm:!h-[98px]" num={6} />
              <Card className="!h-21 sm:!h-[98px]" num={5} />
            </div>
            <div className="flex justify-center">
              <Card className="!h-21 sm:!h-[98px]" num={1} />
      ...
      case 'CUP': {
        return (
          <div className="flex flex-col gap-2 py-6 sm:gap-4 sm:py-12">
            <div className="flex w-full justify-center gap-30 sm:gap-60">
              <Card className="!h-21 sm:!h-[98px]" num={1} />
              <Card className="!h-21 sm:!h-[98px]" num={7} />
            </div>
            <div className="flex w-full justify-center gap-30 sm:gap-60">
              <Card className="!h-21 sm:!h-[98px]" num={2} />
              <Card className="!h-21 sm:!h-[98px]" num={6} />
